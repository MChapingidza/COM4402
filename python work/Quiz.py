...
display_question("question_1")
display_question("question_2")
display_question("question_3")
display_question("question_4")
display_question("question_5")



print("well done you got", score, "out of 5")
